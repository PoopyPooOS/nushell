...
impl StreamWriterSignal {
    ...
    fn lock(&'_ self) -> Result<MutexGuard<'_, StreamWriterSignalState>, ShellError> {
...
impl StreamManagerState {
    ...
    fn lock(
        state: &'_ Mutex<StreamManagerState>,
...
impl StreamManager {
    ...
    fn lock(&'_ self) -> Result<MutexGuard<'_, StreamManagerState>, ShellError> {
